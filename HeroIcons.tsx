...
export const HandShakeIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 10.5c.828 0 1.5-.895 1.5-2s-.672-2-1.5-2S15 7.395 15 8.5s.672 2 1.5 2zM7.5 10.5c.828 0 1.5-.895 1.5-2s-.672-2-1.5-2S6 7.395 6 8.5s.672 2 1.5 2z" />
    </svg>
);
...
export const UsersIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-3.741-1.144M21 12a9 9 0 11-18 0 9 9 0 0118 0zM10.5 9.75L9 12m0 0l1.5 2.25M9 12l1.5-2.25M15 9.75L13.5 12m0 0l1.5 2.25M13.5 12l1.5-2.25" />
  </svg>
);
